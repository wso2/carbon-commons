 ...
 *
 * @see SharedKeyAccessService
 */
public class SharedKeyAccessServiceImpl implements SharedKeyAccessService {

    /* A key to be shared with other components in the same carbon environment*/
    ...
    /**
     * @return Key as a <code>String</code>
     * @see SharedKeyAccessService#getSharedKey()
     */
