...
<%
    ...
    if (null != tableName && !"".equals(tableName)) {
        try {
            ...
            String[] results = client.getFieldNames(dsName, tableName);
...
<div id="returnedResults">
    ...
    <input type="checkbox" name="<%=result%>"
           value="<%=result%>" <%=count == 0 ? "checked" : ""%>/><%=result%><br/>

    <% }
    %>
</div>

<div id="returnedResultsPrimaryField">
...
%>
<div id="returnedResults">
    <font color="#8b0000"> <i>No Fields</i></font>
</div>
<div id="returnedResultsPrimaryField">
    <font color="#8b0000"> <i>No Fields</i></font>
</div>
