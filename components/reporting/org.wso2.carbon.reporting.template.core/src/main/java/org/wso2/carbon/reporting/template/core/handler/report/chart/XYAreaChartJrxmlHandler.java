...
public class XYAreaChartJrxmlHandler extends AbstractXYChartJrxmlHandler{
    private ChartReportDTO chartReport;
       ...
       public XYAreaChartJrxmlHandler(ChartReportDTO chartReport) throws XMLStreamException,
               FileNotFoundException, ReportingException {
               super(chartReport, Template.DEFAULT_XY_AREA_CHART_TEMPLATE.getTemplateName());
               this.chartReport = chartReport;
               this.chartReport.setReportType(ReportConstants.XY_AREA_CHART_TYPE);
           }

     public XYAreaChartJrxmlHandler(String reportName) throws XMLStreamException,
             FileNotFoundException, ReportingException {
         super(reportName);
    }

        public void addXYAreaChartReport() throws ReportingException {
            addXYChartReport("xyAreaChart", "areaPlot", chartReport);
        }
