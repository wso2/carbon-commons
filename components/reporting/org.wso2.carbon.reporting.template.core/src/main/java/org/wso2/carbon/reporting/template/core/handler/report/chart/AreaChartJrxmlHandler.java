...
public class AreaChartJrxmlHandler extends AbstractChartJrxmlHandler {
    ...
    public AreaChartJrxmlHandler(ChartReportDTO chartReport) throws XMLStreamException,
            FileNotFoundException, ReportingException {
        super(chartReport, Template.DEFAULT_AREA_CHART_TEMPLATE.getTemplateName());
        this.chartReport = chartReport;
        this.chartReport.setReportType(ReportConstants.AREA_CHART_TYPE);
    }

    public AreaChartJrxmlHandler(String reportName) throws XMLStreamException,
            FileNotFoundException, ReportingException {
        super(reportName);
    }


    public void addAreaChartReport() throws ReportingException {
        addChartReport("areaChart", "areaPlot", "categoryDataset", "categorySeries",
