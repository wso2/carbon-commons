...
public class XYLineChartJrxmlHandler extends AbstractXYChartJrxmlHandler {
    ...
    public XYLineChartJrxmlHandler(ChartReportDTO chartReport) throws XMLStreamException,
            FileNotFoundException, ReportingException {
        super(chartReport, Template.DEFAULT_XY_LINE_CHART_TEMPLATE.getTemplateName());
        this.chartReport = chartReport;
        this.chartReport.setReportType(ReportConstants.XY_LINE_CHART_TYPE);
    }

    public XYLineChartJrxmlHandler(String reportName) throws XMLStreamException,
            FileNotFoundException, ReportingException {
        super(reportName);
    }

    public void addXYLineChartReport() throws ReportingException {
        addXYChartReport("xyLineChart", "linePlot", chartReport);
    }
