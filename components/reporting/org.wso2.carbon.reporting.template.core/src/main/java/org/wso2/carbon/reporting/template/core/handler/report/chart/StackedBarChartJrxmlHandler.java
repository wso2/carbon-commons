...
public class StackedBarChartJrxmlHandler extends AbstractChartJrxmlHandler{
     ...
     public StackedBarChartJrxmlHandler(ChartReportDTO chartReport) throws XMLStreamException,
             FileNotFoundException, ReportingException {
         super(chartReport, Template.DEFAULT_STACKED_BAR_CHART_TEMPLATE.getTemplateName());
         this.chartReport = chartReport;
         this.chartReport.setReportType(ReportConstants.STACKED_BAR_CHART_TYPE);
     }

     public StackedBarChartJrxmlHandler(String reportName) throws XMLStreamException,
             FileNotFoundException, ReportingException {
         super(reportName);
    }

    public void addStackedBarChartReport() throws ReportingException {
       addChartReport("stackedBarChart", "barPlot", "categoryDataset","categorySeries",
