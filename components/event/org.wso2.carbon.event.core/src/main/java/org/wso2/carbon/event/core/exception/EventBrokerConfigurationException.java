...
public class EventBrokerConfigurationException extends EventBrokerException {
    ...
    public EventBrokerConfigurationException(String message) {
        super(message);
    }

    public EventBrokerConfigurationException(String message, Throwable cause) {
        super(message, cause);
    }

    public EventBrokerConfigurationException(Throwable cause) {
        super(cause);
    }
}
