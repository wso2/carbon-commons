...
<%
    ...
    try {
        transportOutData = client.getGloballyDefinedOutParameters();
    } catch (Exception e) {
        ...
        <div id="workArea">
            ...
            <script type="text/javascript">
                ...
                function enableTransport() {
                    CARBON.showConfirmationDialog("<fmt:message key='transport.sender.enable.message'/>",
                            function() {
            ...
            <table class="styledLeft" id="jmsTransport" width="100%">
                ...
                <tr>
                    <td colspan="2" style="border-left: 0px !important; border-right: 0px !important; border-top: 0px !important; padding-left: 0px !important;">
                        <h4><strong><fmt:message key="transport.sender"/></strong></h4>
                    </td>
                </tr>
                ...
                %>
                            <li>Initial Context Factory := <%=initialFactory%></li>
                <%
                    }
                %>
                <%
                ...
                %>
                            <li>Provider URL := <%=providerUrl%></li>
                <%
                    }
                %>
                <%
                ...
                %>
                    ...
                    <td>
                        <a class="icon-link" style="background-image: url(./images/tranport-config.gif);" href="add_connection_factory.jsp?isSender=true&isUpdate=true&facName=<%=currentParam.getName()%>"> Edit/Remove </a>
                    </td>
                </tr>
                <%
                    }
                ...
                <tr id="noParamsDefined">
                    <td><fmt:message key="no.params.defined"/></td>
                </tr>
                <% } %>
                </tbody>
                <tr>
                    <td colspan="3" class="buttonRow">
                        <input name="backBtn" class="button" type="reset" value="Back"  onclick="javascript:window.history.go(-1); return false;"/>
                    </td>
                </tr>

            </table>
        </div>
        <a class="icon-link" style="background-image: url(../admin/images/add.gif);" href="add_connection_factory.jsp?isSender=true"> <fmt:message key="transport.jms.factory.add"/> </a>
