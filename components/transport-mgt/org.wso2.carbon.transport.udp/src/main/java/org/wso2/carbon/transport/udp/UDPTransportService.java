...
package org.wso2.carbon.transport.udp;
 ...
 *
 */
public class UDPTransportService extends AbstractTransportService {

    public static final String TRANSPORT_NAME = "udp";
	public static final String TRANSPORT_CONF = "udp-transports.xml";

	/**
	 * Instantiates UDPTransportService with a reference to the AxisConfiguration.
	 */
