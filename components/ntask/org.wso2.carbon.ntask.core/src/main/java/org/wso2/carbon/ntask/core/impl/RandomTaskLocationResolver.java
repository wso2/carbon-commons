 ...
 * tasks to the task cluster. This implementation is much more performant 
 * than the round robin based one, since the round robin resolver requires 
 * the full list of tasks for the tenant/task-type to be loaded.
 */
