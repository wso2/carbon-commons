...
public class MultipleCredentialsUserAdmin {
	...
	// public void updateCredentialByUser(Credential credential) throws
	// MultipleCredentialsUserAdminException {
	// MultipleCredentialsUserProxy multipleCredentialsUserProxy = new
	// MultipleCredentialsUserProxy(super.getUserRealm());
