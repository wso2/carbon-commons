...
public class RemoteLoggingConfigDataHolder {
    ...
    public RemoteLoggingConfigDAO getRemoteLoggingConfigDAO() {

        if (remoteLoggingConfigDAO != null) {
            return remoteLoggingConfigDAO;
        }
        return defaultRemoteLoggingConfigDAO;
    }
