...
//        $(".request_url", $(this.el)).html("<pre>" + invocationUrl + "</pre>");
        $(".response_throbber", $(this.el)).show();
          ...
          if (typeof(this.model.supportedContentTypes)==="undefined"){
              contentTypeOfRequest   = "";
          } else {
              contentTypeOfRequest   = this.model.supportedContentTypes[0];
          }

          var testHeaders= {"requestedUrl": invocationUrl, "requestHttpMethod":this.model.httpMethod, "bodyParam":encodeURI(bodyParam), "contentType":contentTypeOfRequest}

/*          console.log(testHeaders);
          console.log("......WW WWWWWWWWWWWWWWWW   .... : "+JSON.stringify(testHeaders))
          ...
          console.log(this);
          console.log("------------");*/
        //  if(invocationUrl.indexOf(x)==-1){
              var rl = x + getProxyAddress();
              console.log(rl);
              invocationUrl =  contextRoot +  getProxyAddress();
         // }
          for(_p=0, _len5= headerParams.length;_p<_len5;_p++){
              console.log(headerParams[_p]) ;
          }
...
//          headers: testHeaders,
          data: JSON.stringify(testHeaders),
          dataType: 'json',
          processData: false,
        ...
        paramContentTypeField = $("td select[name=contentType]", $(this.el)).val();
          console.log("paramContentTypeField ..................."+paramContentTypeField)
      ...
      function getProxyAddress() {
          return "carbon/tryit/JAXRSRequestXSSproxy_ajaxprocessor.jsp";
      }
