...
<carbon:breadcrumb label="edit.datasource" resourceBundle="org.wso2.carbon.datasource.ui.i18n.Resources"
...
<tr>
    ...
    <td align="left">
        <input id="driver" name="driver" class="longInput" value="<%=information.getDriver()==null?"":information.getDriver()%>"/>
    </td>
</tr>
<tr>
    <td><fmt:message key="url"/><span class='required'>*</span></td>
    <td align="left">
        <input id="url" name="url" class="longInput" value="<%=information.getUrl()==null?"":information.getUrl()%>"/>
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td>
        ...
        <% } else {%>
        <input type="radio" name="dsrepotype" value="InMemory" onclick="setRepository('InMemory');"/>
        <fmt:message key="inmemory"/>

        <input type="radio" name="dsrepotype" value="JNDI" checked="true" onclick="setRepository('JNDI');"/>
        <fmt:message key="jndi"/>
...
<tr>
    <td><fmt:message key="max.wait"/><label><fmt:message key="measurement.milliseconds"/></label></td>
    <td align="left">
...
<tr>
    ...
    <td align="left">
        <input id="initialsize" name="initialsize" type="text" value="<%=information.getInitialSize()%>"/>
    </td>
</tr>
<tr>
...
<tr>
    <td class="buttonRow" colspan="3">
        ...
        <input class="button" type="button"
               ...
               onclick="dsSave('<fmt:message key="ds.name.cannotfound.msg"/>','<fmt:message key="ds.name.invalid.msg"/>','<fmt:message key="ds.driver.cannotfound.msg"/>','<fmt:message key="ds.url.cannotfound.msg"/>',document.dseditform); return false;"/>
